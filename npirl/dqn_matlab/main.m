clear all; clc;
close all;
%% State & action space 생성
% 상태 : S
obsInfo = rlNumericSpec([14 1]);  % 상태는 S, I, R
obsInfo.Name = 'SIR States';
obsInfo.Description = 'S, E, I, H, R, EV1, IV1, EV2, IV2, V1, V2, new_inf, F, SI';
obsInfo.LowerLimit = 0;

actInfo = rlFiniteSetSpec([0.4402, 0.4402*1.4, 0.4402*(1.4^2), 1]);  % 가능한 백신 접종률
actInfo.Name = 'Vaccination Rate';

%% environment 생성
env = rlFunctionEnv(obsInfo, actInfo, 'covid_step', 'covid_reset');
